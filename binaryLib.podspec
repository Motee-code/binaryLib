#
# Be sure to run `pod lib lint binaryLib.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'binaryLib'
  s.version          = '0.1.0'
  s.summary          = 'A short description of binaryLib.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'binaryLib/Classes/**/*'
  
  # s.resource_bundles = {
  #   'binaryLib' => ['binaryLib/Assets/*.png']
  # }
